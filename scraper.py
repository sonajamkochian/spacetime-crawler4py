...
def is_valid(url):
    ...
    try:
        ...
        filters = ["https://isg.ics.uci.edu/events/", ".war", "?ical=", ".php", "https://www.ics.uci.edu/~eppstein/pix/",
                   ...
                   "timeline?", "?format=", "precision=second", "https://wics.ics.uci.edu/events/", "wics.ics.uci.edu/events", 
                   "wics.ics.uci.edu/event", "login", ".txt", ".zip", ".pdf", ".ps", ".m", ".tex", ".sql", "&format=txt"]
